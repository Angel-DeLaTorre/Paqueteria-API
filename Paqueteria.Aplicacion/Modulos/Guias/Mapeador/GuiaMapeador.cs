...
using Paqueteria.Application.Modulos.Clientes.Mepador;
...
public static class GuiaMapeador
{
    ...
    extension(Guia guia)
    {
        public GuiaRespuestaDto ARespuestaDto()
        {
            var clienteOrigen = guia.ClienteOrigen.ARespuestaDto();
            var direccionOrigen = guia.DireccionOrigen.ARespuestaDto();
            var clienteDestino = guia.ClienteDestino.ARespuestaDto();
            var direccionDestino = guia.DireccionDestino.ARespuestaDto();
            // Protege contra colecciones nulas
            var articulos = guia.ArticulosGuia?.Select(a => a.ARespuestaDto()) ?? [];
    ...
    private static DireccionGuiaSnapRespuestaDto ARespuestaDto(this DireccionGuiaSnapshot entidad)
    {
        return new DireccionGuiaSnapRespuestaDto(
            entidad.Id,
            entidad.Direccion.ARespuestaDto(),
