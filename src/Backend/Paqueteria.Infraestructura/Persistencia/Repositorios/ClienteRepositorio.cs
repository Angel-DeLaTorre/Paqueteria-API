...
public class ClienteRepositorio(AppDbContext context) : IClienteRepositorio
{
    ...
    public async Task<bool> ExisteAsync(Guid clienteId, CancellationToken cancellationToken = default)
    {
        return await context.Clientes
