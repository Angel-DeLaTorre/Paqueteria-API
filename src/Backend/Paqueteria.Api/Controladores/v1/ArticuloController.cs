...
{
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<ArticuloRespuestaDto>>> Get()
    {
    ...
    public async Task<ActionResult<ArticuloRespuestaDto>> Get(Guid id)
    {
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    public async Task<ActionResult<ArticuloRespuestaDto>> Create(ArticuloCrearDto dto)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update([FromBody] ArticuloActualizarDto dto)
    {
