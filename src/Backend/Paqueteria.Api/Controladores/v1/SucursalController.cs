...
{
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<SucursalRespuestaDto>>> Get()
    {
    ...
    public async Task<ActionResult<SucursalRespuestaDto>> Get(Guid id)
    {
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    public async Task<ActionResult<SucursalRespuestaDto>> Create(SucursalCrearDto dto)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update([FromBody] SucursalActualizarDto dto)
    {
