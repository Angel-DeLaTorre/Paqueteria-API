...
{
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<ClienteRespuestaDto>>> Get()
    {
    ...
    public async Task<ActionResult<ClienteRespuestaDto>> Get(Guid id)
    {
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    public async Task<ActionResult<ClienteRespuestaDto>> Create([FromBody] ClienteCrearDto dto)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update([FromBody] ClienteActualizarDto dto)
    {
