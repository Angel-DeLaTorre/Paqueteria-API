        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionMunicipioId = table.Column<Guid>(name: "Direccion.MunicipioId", type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_direcciones_guia_snapshot", x => x.id);
                    table.ForeignKey(
                        name: "FK_direcciones_guia_snapshot_municipios_Direccion.MunicipioId",
                        column: x => x.DireccionMunicipioId,
                        principalSchema: "catalogos",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_empresas_municipios_Direccion.MunicipioId",
                        column: x => x.DireccionMunicipioId,
                        principalSchema: "catalogos",
                        principalTable: "municipios",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionMunicipioId = table.Column<Guid>(name: "Direccion.MunicipioId", type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_choferes_municipios_Direccion.MunicipioId",
                        column: x => x.DireccionMunicipioId,
                        principalSchema: "catalogos",
                        principalTable: "municipios",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_sucursales_municipios_Direccion.MunicipioId",
                        column: x => x.DireccionMunicipioId,
                        principalSchema: "catalogos",
                        principalTable: "municipios",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_guias_seguros_SeguroId",
                        column: x => x.SeguroId,
                        principalSchema: "remisiones",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_asignaciones_guias_guia_id",
                        column: x => x.guia_id,
                        principalSchema: "remisiones",
                        principalTable: "guias",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_choferes_Direccion.MunicipioId",
                schema: "remisiones",
                table: "choferes",
                column: "Direccion.MunicipioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_direcciones_guia_snapshot_Direccion.MunicipioId",
                schema: "remisiones",
                table: "direcciones_guia_snapshot",
                column: "Direccion.MunicipioId");

            migrationBuilder.CreateIndex(
                name: "IX_empresas_Direccion.MunicipioId",
                schema: "remisiones",
                table: "empresas",
                column: "Direccion.MunicipioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sucursales_Direccion.MunicipioId",
                schema: "remisiones",
                table: "sucursales",
                column: "Direccion.MunicipioId");
