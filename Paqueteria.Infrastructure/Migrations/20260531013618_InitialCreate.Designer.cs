...
namespace Paqueteria.Infrastructure.Migrations
{
    ...
    [Migration("20260531013618_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.DireccionCliente", b =>
                {
                    ...
                    b.ToTable("direcciones_cliente", "remisiones");
                });
            ...
            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.Permiso", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("permisos", "remisiones");
                });

            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.Rol", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("roles", "remisiones");
                });

            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.RolPermiso", b =>
                {
                    ...
                    b.ToTable("roles_permisos", "remisiones");
                });
            ...
            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.UsuarioRol", b =>
                {
                    b.Property<Guid>("UsuarioId")
                        .HasColumnType("uuid")
                        .HasColumnName("usuario_id");
                    ...
                    b.ToTable("usuarios_roles", "remisiones");
                });
                    ...
                    b.OwnsOne("Paqueteria.Core.ValueObjects.Direccion", "Direccion", b1 =>
                        {
                            ...
                            b1.ToTable("direcciones_cliente", "remisiones");
            ...
            modelBuilder.Entity("Paqueteria.Core.Entities.Remisiones.RolPermiso", b =>
                {
                    b.HasOne("Paqueteria.Core.Entities.Remisiones.Permiso", "Permiso")
                        .WithMany("RolPermiso")
                        .HasForeignKey("PermisoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Paqueteria.Core.Entities.Remisiones.Rol", "Rol")
                        .WithMany("RolPermiso")
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
